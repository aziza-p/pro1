        ...
        >
          ...
          <FormGroup>
            ...
            >
              ...
              <optgroup label="Jewelry Set ">
                <option value="Aveline Set">Aveline Set</option>
                <option value="Viora Set">Viora Set</option>
                <option value="Vivia Set"> Vivia Set</option>
                <option value="Diora Set">Diora Set</option>
                <option value="Lumi Set">Lumi Set</option>
                <option value="Elara Set">Elara Set</option>
              </optgroup>
              <optgroup label="Rings Collection">
                <option value="Golden Halo">Golden Halo</option>
                <option value="Blossom Vine">Blossom Vine</option>
                <option value="Forever Yours">Forever Your</option>
              </optgroup>
            </Input>
          </FormGroup>
