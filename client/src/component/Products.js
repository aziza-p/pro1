...
import img2 from "./Photos/IMG_7023.jpeg";
import img3 from "./Photos/IMG_7031.jpeg";
import img4 from "./Photos/IMG_7028.jpeg";
import img5 from "./Photos/IMG_7021.jpeg";
import img6 from "./Photos/IMG_7462.jpeg";
    ...
    <div className="products-container">
      ...
      <Row>
        <div className="beauty-collection-content mt-4">
          ...
          >
            Bariq Jewelry Collection
          </h2>
          <p
            className="collection-description"
            style={{ color: "#555", fontSize: "16px", margin: "20px 0" }}
          >
            Bariq Jewelry Your sparkle, your story.
          </p>
          <Button
            color="dark"
            style={{
